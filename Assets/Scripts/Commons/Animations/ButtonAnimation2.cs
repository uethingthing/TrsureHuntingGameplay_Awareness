...
/// ボタンアニメーション
/// </summary>
public class ButtonAnimation2 : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    /// <summary>
    ...
    /// 拡大したサイズ
    /// </summary>
    private Vector3 m_ZoomSize = Vector3.one * 1.1f;
    ...
    {
        //自分のターンでなければ拡大しない
        if (GameInfo.MyTurn != GameInfo.Game.Turn) { return; }
